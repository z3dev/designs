...
function getZ(p) {
    var cag111 = new CSG.Path2D([[90.25,-35.25]],false);
    ...
    cag11 = cag111.scale([p.scale,p.scale]);
    // and apply 3D operations
    csg = cag11.extrude({offset: [0,0,p.z_z]});
    csg = csg.setColor(p.z_color);
    return csg;
}
function get3(p) {
    var cag131 = new CSG.Path2D([[215.5,-115.19]],false);
    ...
    // and apply 3D operations
    csg = cag131.extrude({offset: [0,0,p.t_z]});
    csg = csg.setColor(p.t_color);
    return csg;
}
function getD(p) {
    var cag101 = new CSG.Path2D([[357.17,-32.08]],false);
    ...
    var cag121 = new CSG.Path2D([[371.75,-60.29]],false);
    ...
    // and apply 3D operations
    csg = cag101.extrude({offset: [0,0,p.d_z]});
    csg = csg.setColor(p.d_color);
    return csg;
}
function getDot(p) {
    var cag181 = new CSG.Path2D([[452,-213]],false);
    ...
    // and apply 3D operations
    csg = cag181.extrude({offset: [0,0,p.dot_z]});
    csg = csg.setColor(p.dot_color);
    return csg;
}
function getJ(p) {
    var cag141 = new CSG.Path2D([[500.5,-128.05]],false);
    ...
    var cag161 = new CSG.Path2D([[501.75,-156.25]],false);
    ...
    // and apply 3D operations
    csg = cag141.extrude({offset: [0,0,p.j_z]});
    csg = csg.setColor(p.j_color);
    return csg;
}
function getP(p) {
    var cag151 = new CSG.Path2D([[566,-155.07]],false);
    ...
    var cag171 = new CSG.Path2D([[562.5,-168.7]],false);
    ...
    // and apply 3D operations
    csg = cag151.extrude({offset: [0,0,p.p_z]});
    csg = csg.setColor(p.p_color);
    return csg;
}

function getLogo(p) {
    var cag101 = new CSG.Path2D([[67.72486772486774,-2.246031746031746]],false);
    cag101 = cag101.appendBezier([[64.30687830687832,-2.2063492063492065],[61.092592592592595,-2.2222222222222223],[60.58201058201058,-2.2804232804232805]]);
    cag101 = cag101.appendBezier([[60.07407407407408,-2.3412698412698414],[58.40740740740741,-2.5793650793650795],[56.87830687830688,-2.8121693121693125]]);
    cag101 = cag101.appendBezier([[55.351851851851855,-3.0423280423280423],[52.73280423280424,-3.568783068783069],[51.058201058201064,-3.9788359788359786]]);
    cag101 = cag101.appendBezier([[49.38624338624339,-4.3915343915343925],[46.76719576719577,-5.158730158730159],[45.23809523809524,-5.685185185185185]]);
    cag101 = cag101.appendBezier([[43.71164021164021,-6.214285714285714],[40.55555555555556,-7.576719576719578],[38.22751322751323,-8.716931216931219]]);
    cag101 = cag101.appendBezier([[35.8994708994709,-9.854497354497354],[32.6031746031746,-11.722222222222223],[30.904761904761905,-12.867724867724869]]);
    cag101 = cag101.appendBezier([[29.20634920634921,-14.010582010582011],[26.645502645502646,-15.91798941798942],[25.216931216931215,-17.103174603174605]]);
    cag101 = cag101.appendBezier([[23.78835978835979,-18.28571428571429],[21.605820105820108,-20.30952380952381],[20.367724867724867,-21.600529100529105]]);
    cag101 = cag101.appendBezier([[19.12962962962963,-22.88888888888889],[17.343915343915345,-24.894179894179892],[16.399470899470902,-26.055555555555557]]);
    cag101 = cag101.appendBezier([[15.455026455026456,-27.21957671957672],[13.806878306878307,-29.48148148148148],[12.738095238095239,-31.082010582010582]]);
    cag111 = cag111.appendPoint([108.86243386243387,-94.04761904761905]);
    cag111 = cag111.appendPoint([109.65608465608466,-94.4867724867725]);
    cag111 = cag111.appendBezier([[110.0925925925926,-94.72751322751323],[110.76984126984127,-95.26455026455028],[111.16137566137567,-95.67724867724868]]);
    cag111 = cag111.appendBezier([[111.55026455026456,-96.0899470899471],[111.99735449735451,-96.75661375661376],[112.15343915343915,-97.15608465608466]]);
    cag111 = cag111.appendBezier([[112.3068783068783,-97.55555555555556],[112.43121693121694,-98.3888888888889],[112.43121693121694,-99.0079365079365]]);
    cag111 = cag111.appendBezier([[112.42857142857144,-99.62698412698413],[112.19047619047619,-100.63756613756615],[111.9021164021164,-101.25661375661376]]);
    cag111 = cag111.appendBezier([[111.52645502645503,-102.05555555555556],[111.01322751322752,-102.5899470899471],[110.11904761904762,-103.10846560846561]]);
    cag111 = cag111.appendPoint([108.86243386243387,-103.83597883597884]);
    cag111 = cag111.appendPoint([72.4867724867725,-103.91005291005291]);
    cag111 = cag111.appendBezier([[46.1931216931217,-103.96560846560847],[35.780423280423285,-103.90476190476191],[34.920634920634924,-103.6878306878307]]);
    cag111 = cag111.appendBezier([[34.26719576719577,-103.52380952380953],[33.402116402116405,-103.16402116402116],[33.00264550264551,-102.8862433862434]]);
    cag111 = cag111.appendBezier([[32.6031746031746,-102.60846560846562],[32.007936507936506,-101.87566137566138],[31.67989417989418,-101.25661375661376]]);
    cag111 = cag111.appendPoint([31.084656084656086,-100.13227513227514]);
    cag111 = cag111.appendPoint([31.013227513227516,-64.02116402116403]);
    cag111 = cag111.appendBezier([[30.968253968253972,-40.30687830687831],[31.034391534391535,-27.433862433862437],[31.211640211640216,-26.521164021164022]]);
    cag111 = cag111.appendBezier([[31.42063492063492,-25.449735449735453],[31.72222222222222,-24.891534391534393],[32.539682539682545,-24.074074074074076]]);
    cag111 = cag111.appendBezier([[33.12169312169313,-23.492063492063494],[33.98412698412699,-22.902116402116402],[34.45767195767196,-22.761904761904766]]);
    cag111 = cag111.appendBezier([[34.93121693121693,-22.621693121693124],[35.854497354497354,-22.566137566137566],[36.50793650793651,-22.634920634920636]]);
    cag111 = cag111.close();
    cag111 = cag111.innerToCAG(); // inner

    // convert the circle to a sphere
    var b = cag101.getBounds();
    var x = (b[1].x - b[0].x);
    var y = (b[1].y - b[0].y);
    var r = Math.max(x/2,y/2);
    var s = CSG.sphere({radius: r, resolution: p.resolution});
    x = b[0].x + r;
    y = b[0].y + r;
    s = s.translate([x,y,0]);
    // convert the inside to 3D
    var i = cag111.extrude({offset: [0,0,r*2]}).translate([0,0,-r]);
    // and remove the inside from the sphere
    s = s.subtract(i);
    // adjust position
    s = s.translate([-x,-y,0]);
    s = s.scale([p.l_scale,p.l_scale,p.l_scale]);
    s = s.translate(p.l_offset);
    s = s.setColor(p.l_color);
    return s;
}
...
function main( p ) {
    var s = use("http://www.z3d.jp/lab/data/lab-000000059/iphone4-case.json");
    var icase = CSG.cube();
    ...
    var neg = getZ(p).union(getD(p)).union(getDot(p)).union(getJ(p)).union(getP(p));
    neg = neg.rotateZ(90);
