...
// create the bottom
    var b = CSG.roundedCube({center: [0, 0, 0], radius: [p.bottom_length_r,p.bottom_width_r,p.bottom_thickness_r], roundradius: p.corner_radius, resolution: p.resolution}); 

// create the sides for the bottom
    var o = CAG.roundedRectangle({center: [0,0], radius: [p.bottom_length_r, p.bottom_width_r], roundradius: p.corner_radius, resolution: p.resolution});
    var i = CAG.roundedRectangle({center: [0,0], radius: [p.bottom_length_r-p.side_thickness, p.bottom_width_r-p.side_thickness], roundradius: p.corner_radius, resolution: p.resolution});
    o = o.subtract(i);
...
// create the top
    var t = CSG.roundedCube({center: [0, 0, 0], radius: [p.top_length_r,p.top_width_r,p.top_thickness_r], roundradius: p.corner_radius, resolution: p.resolution});
